//#region node_modules/.pnpm/countries-and-timezones@3.8.0/node_modules/countries-and-timezones/esm/index.js
...
function buildTimezone(data, name) {
	...
	var tz = _objectSpread2(_objectSpread2({}, aliasOf ? data.timezones[aliasOf] : {}), data.timezones[name]);
	var countries = tz.c || [];
	var utcOffset = tz.u;
